...
global store_agri_mach = "$main_folder/data/store_collapse/agri_machinery"
global tempfile_agri_mach = "$main_folder/data/store_collapse/agri_machinery"
...
* The obtained dataset will show the AVERAGE for each mexican state in each quarter. HOWEVER, this is not restricted at the RURAL LEVEL. 
preserve
...
* Collapse the dataset from each quarter to obtain the percentage of women living in rural areas, that are not working due to lack of labor demand
* The obtained dataset will show the NATIONAL AVERAGE for each quarter
preserve
...
tempfile national_rur_labor_demand_`year_quarter'
save "`national_rur_labor_demand_`year_quarter''"
restore 


* Collapse the dataset from each quarter to obtain the percentage of women living in rural areas of each mexican municipalities, that are not working due to lack of labor demand
...
clear 
use "$store_labor_demand\state_rur_labor_demand_105.dta"

forvalues i=106(1)119 {
append using "$store_labor_demand\state_rur_labor_demand_`i'.dta"	
}
...
save "$store_agri_mach/state_agri_mach_ratio`year_quarter'.dta", replace
...
save "$store_agri_mach/national_agri_mach_ratio`year_quarter'.dta", replace
tempfile national_agri_mach_ratio_`year_quarter'
save national_agri_mach_ratio_`year_quarter'
