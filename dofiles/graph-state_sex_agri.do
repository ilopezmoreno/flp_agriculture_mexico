...
use state_sex_agri_2005_2019

graph bar (mean) sexagri, over(quarter) over(year) yscale(range(0 40)) by(entity_name, noedgelabel compact rows(4))
...
gr_edit .title.text.Arrpush `"of all people working in agriculture. (32 Mexican States, 2005 - 2019)"'
...
graph save "Graph" "$graphs_gph\states_sex-agri.gph", replace
graph export "$graphs_jpg\states_sex-agri.png", replace